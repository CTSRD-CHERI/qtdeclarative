...
constexpr size_t pointerAlign = alignof(void *) > 8 ? alignof(void *) : 8;
constexpr size_t vectorAlign = alignof(void *) > 16 ? alignof(void *) : 16;
...
#else
#endif
    qintptr offsetOnCheri; // always little endian, will never be a capability
#else
...
static_assert(offsetof(QStringData, _internal_cheri_offset) == offsetof(String, offsetOnCheri),
